...
class SearchResultsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let tableView: UITableView = {
        ...
        tableView.register(SearchResultDefaultTableViewCell.self, forCellReuseIdentifier: SearchResultDefaultTableViewCell.idevtifier)
        ...
        // delete, else sections isHidden = true
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .artist(let artist):
            ...
            guard let cell = tableView.dequeueReusableCell(
                withIdentifier: SearchResultDefaultTableViewCell.idevtifier,
                for: indexPath
