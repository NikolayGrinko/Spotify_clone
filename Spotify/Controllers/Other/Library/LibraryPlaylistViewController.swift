...
//  Spotify
//
//  Created by Николай Гринько on 23.06.2023.
//
...
class LibraryPlaylistViewController: UIViewController {
    ...
    private func updateUI() {
        if playlists.isEmpty {
            ...
            noPlaylistsView.isHidden = false // в проекте стоит false
            tableView.isHidden = true
        }
        else {
            // Show table
...
extension LibraryPlaylistViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: SearchResultsSubtitleTableViewCell.identifier, for: indexPath
