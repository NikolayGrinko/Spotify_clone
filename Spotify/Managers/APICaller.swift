...
public func getCurrentUserPlaylists(completion: @escaping (Result<[Playlist], Error>) -> Void) {
    ...
    public func createPlaylist(with name: String, completion: @escaping (Bool) -> Void) {
        getGurrentUserProfile { [weak self] result in
            switch result {
            ...
            let task = URLSession.shared.dataTask(with: request) { data, response, error in
                ...
                do {
                    ...
                    if let response = result as? [String: Any],
                       response["snaoshot_id"] as? String != nil {
                        completion(true)
                    }
                    else {
                        print(result)
    ...
    public func getGurrentUserProfile(completion: @escaping (Result<UserProfile, Error>) -> Void) {
        createRequest(
        ...
        createRequest(
            ...
            let task = URLSession.shared.dataTask(with: request) { data, _, error in
                ...
                do {
                    ...
                    searchResults.append(contentsOf: result.album.items.compactMap({ .album(model: $0) }))
